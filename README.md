# odoo14
nstalling Odoo 14 with one command.
...
``` bash
curl -s https://raw.githubusercontent.com/moussa154/odoo14/master/run.sh | sudo bash -s odoo-one 10015 20015
```
...
``` bash
curl -s https://raw.githubusercontent.com/moussa154/odoo14/master/run.sh | sudo bash -s odoo-two 11015 21015
```
...
``` sh
$ git clone https://github.com/moussa154/odoo14.git
